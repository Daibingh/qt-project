...
static const char qt_meta_stringdata_maskmainwidget[] = {
    "maskmainwidget\0"
};
...
const QMetaObjectExtraData maskmainwidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject maskmainwidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_maskmainwidget,
      qt_meta_data_maskmainwidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &maskmainwidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_maskmainwidget))
